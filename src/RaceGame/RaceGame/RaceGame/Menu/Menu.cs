...
namespace RaceGame.Menu
{
    public abstract class Menu : IMenu
    {
        ...
        private const int MENU_POSITION_X = 10;
        private const int MENU_POSITION_Y = 5;
        ...
        public void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_font, Description, new Vector2(MENU_POSITION_X, MENU_POSITION_Y), Color.White);
